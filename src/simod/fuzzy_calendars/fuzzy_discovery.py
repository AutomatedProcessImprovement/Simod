        ...
        resource_calendars.append(
            {
                ...
                "time_periods": sweep_line_intervals(fuzzy_calendars[r_id].res_absolute_prob, i_size),
            ...
            time_periods.append(
                {
                    "from": days_str[w_day],
                    "to": days_str[w_day],
                    "beginTime": str(interval_index_to_time(from_i, i_size, True).time()),
                    "endTime": str(interval_index_to_time(to_i, i_size, True).time()),
