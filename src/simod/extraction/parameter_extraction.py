...
from simod.structure_params_miner import ParameterExtractionOutput
...
#             args['arr_cal_met'] = self.settings.arr_cal_met
#
...
class LogReplayerForExtractionPipeline(Operator):
...
class ResourceMinerForExtractionPipeline(Operator):
    input: ParameterExtractionInput
    output: ParameterExtractionOutput
