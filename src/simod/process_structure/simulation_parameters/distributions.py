...
class DistributionType(Enum):
    ...
    def from_string(value: str) -> 'DistributionType':
        ...
        elif name in ('lognorm', 'log_normal'):
...
class Distribution:
    ...
    def from_simod_dict(simod_dict: dict, min_duration: float = 0, max_duration: float = MAX_FLOAT) -> 'Distribution':
        ...
        if kind == DistributionType.UNIFORM:
            parameters = [
                DistributionParameter(DistributionParameterType.LOC, simod_dict['dparams']['arg1']),
                DistributionParameter(DistributionParameterType.SCALE,
                                      simod_dict['dparams']['arg2'] - simod_dict['dparams']['arg1']),
            ...
            parameters = [
                DistributionParameter(DistributionParameterType.LOC, simod_dict['dparams']['mean']),
                DistributionParameter(DistributionParameterType.SCALE, simod_dict['dparams']['arg1']),
                DistributionParameter(DistributionParameterType.MIN, min_duration),
                DistributionParameter(DistributionParameterType.MAX, max_duration)
            ]
        elif kind == DistributionType.TRIANGULAR:
            parameters = [
                DistributionParameter(DistributionParameterType.MODE, simod_dict['dparams']['mean']),
                DistributionParameter(DistributionParameterType.LOC, simod_dict['dparams']['arg1']),
                DistributionParameter(DistributionParameterType.SCALE, simod_dict['dparams']['arg2'] - simod_dict['dparams']['arg1']),
                DistributionParameter(DistributionParameterType.MIN, min_duration),
                DistributionParameter(DistributionParameterType.MAX, max_duration)
            ]
            ...
            mean_2 = simod_dict['dparams']['mean'] ** 2
            variance = simod_dict['dparams']['arg1']
            ...
            mean, variance = simod_dict['dparams']['mean'], simod_dict['dparams']['arg1']
