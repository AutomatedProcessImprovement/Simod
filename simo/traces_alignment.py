...
def align_traces(alignment_input, log, align_info_file, align_type_file):
    """this method is the kernel of all the alignment process"""
    optimal_alignments = read_alignment_info(alignment_input,align_info_file)
    traces_alignments = traces_alignment_type(alignment_input,align_type_file)
...
def read_alignment_info(alignment_input, file_name):
    filename = alignment_input + chr(92) + file_name
    records = list()
...
def traces_alignment_type(alignment_input, file_name):
    filename = alignment_input + chr(92) + file_name
    records = list()
    with open(filename) as fp:
