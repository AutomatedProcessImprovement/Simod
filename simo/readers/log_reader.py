...
class LogReader(object):
    ...
    def __init__(self, input,log_columns_numbers, start_timeformat, end_timeformat, ns_include=True):
        """constructor"""
        self.input = input
        self.data, self.raw_data = self.load_data_from_file(log_columns_numbers, start_timeformat, end_timeformat, ns_include)
    ...
    # Reading methods
    def load_data_from_file(self, log_columns_numbers, start_timeformat, end_timeformat, ns_include):
    ...
    def get_xes_events_data(self, filename,start_timeformat, end_timeformat, ns_include):
